      ...
      <div className="container">
        <div className="row slider-text align-items-center" data-scrollax-parent="true">
          <div className="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Blockchain Health Vault</h1>
            <p className="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">An AI-powered healthcare platform offering symptom analysis, appointment scheduling, blockchain-secured medical records, and real-time medical assistance — all in one place.</p>
